...
This project demonstrates the complete DevOps lifecycle — from code commit to automated build, test, containerization, and cloud deployment.
...
⚙️ Deployment on AWS EC2 & AWS ECS

🔁 Fully automated CI/CD pipeline using Jenkins (Maven build + Docker build + Deploy)
...
Local: http://localhost:8082/employee
